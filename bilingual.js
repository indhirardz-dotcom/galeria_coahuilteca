(function () {
  ...
  const dictionary = {
    ...
    "The Jacarandas series was exhibited at El Nigromante in San Miguel de Allende.": "La serie Jacarandas se presentó en El Nigromante de San Miguel de Allende.",
    "Read the INBAL exhibition announcement": "Lee el comunicado del INBAL",
    "Galería Coahuilteca is an independent working art gallery at the corner of Tenerías and Codo in the historic center of San Miguel de Allende, near Parque Benito Juárez. Meet the artists through original paintings, drawings and ceramics, or arrange a private viewing with the gallery.": "Galería Coahuilteca es una galería de arte independiente y un espacio de creación en la esquina de Tenerías y Codo, en el centro histórico de San Miguel de Allende, cerca del Parque Benito Juárez. Conoce a quienes crean aquí a través de pintura, dibujo y cerámica originales, o solicita una visita privada.",
    "Explore available artwork": "Explora la obra disponible",
    "Discover private art experiences": "Conoce las experiencias artísticas privadas",
